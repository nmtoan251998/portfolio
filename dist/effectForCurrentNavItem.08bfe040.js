...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../assets/js/effectForCurrentNavItem.js":[function(require,module,exports) {
document.addEventListener("DOMContentLoaded", function () {
  // current navbar
  var aboutEle = document.getElementById('about');
  var contactEle = document.getElementById('contact');
  var skillEle = document.getElementById('skills');
  var workEle = document.getElementById('works');
  var eduEle = document.getElementById('edu'); // current position

  var aboutSectionYOffset = aboutEle.offsetTop;
  var contactSectionYOffset = contactEle.offsetTop;
  var skillSectionYOffset = skillEle.offsetTop;
  var workSectionYOffset = workEle.offsetTop;
  var eduSectionYOffset = eduEle.offsetTop;
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../assets/js/effectForCurrentNavItem.js"], null)
//# sourceMappingURL=/effectForCurrentNavItem.08bfe040.js.map